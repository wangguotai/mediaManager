...
- 我的 Tab 存储概览卡片（图片/视频/Live 分类统计 + 总计）
- 设置页后端地址显示
- 设置页清除缩略图缓存按钮
- 文件管理标题显示总数 (N 项)
- 图片预览页收藏按钮（星星图标切换）
- 后端 API 增强：min_size/max_size + date_from/date_to 范围筛选
- 后端 /api/media/storage-stats 按类型分组存储统计端点
- PRD-v8 规划文档

## 3. Commit 链（26 个 commit）

c37c5d0 → aa14591 → d14f11c → 2452acb → 57b8382 → e46ecb9 → f341fa6 → 69087f2 → 62147fa → 2e67c0f → ef5c93a → 123aec6 → 5706579 → ad0aadf → f201803 → 8c9c718 → 4215da1 → a0e9b0d → 1102aba → 3722ed2 → 9d4be21 → 05ab540 → f5f9110 → 1cb2782 → 8cebb00 → eb62fba → bcb4277

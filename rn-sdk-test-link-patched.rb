...
require 'open3'
require 'pathname'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/react_native_pods_utils/script_phases.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/jsengine.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/rndependencies.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/rncore.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/fabric.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/codegen.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/codegen_utils.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/utils.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/new_architecture.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/local_podspec_patch.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/runtime.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/helpers.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/privacy_manifest_utils.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/spm.rb'
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/rncore.rb'
# Importing to expose use_native_modules!
require_relative '/Users/wgt/projects/rn_test/packages/react-native/scripts/cocoapods/autolinking.rb'
...
def use_react_native! (
  ...
  # patched: use absolute path for codegen cleanup
  codegen_path = Pathname.new(path).absolute? ? path : File.join(relative_path_from_current, path)
  CodegenUtils.clean_up_build_folder(codegen_path, $CODEGEN_OUTPUT_DIR)
  ...
  # patched: support absolute paths (cross-project reference)
  if Pathname.new(path).absolute?
    react_native_version = NewArchitectureHelper.extract_react_native_version(path)
  else
  ...
  # patched: use absolute path for prefix (cross-project reference)
  prefix = Pathname.new(path).absolute? ? path : File.join(relative_path_from_current, path)
